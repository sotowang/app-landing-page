      ...
      <section className="py-16 px-4">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="mb-4">We may collect, store, and use the following types of personal information:</p>
            ...
            <p className="mb-4">Personal information submitted to us through our website will be used for the purposes specified in this policy. We may use your personal information for the following purposes:</p>
            <ul className="list-disc pl-8 mb-4">
            ...
            <h2 className="text-2xl font-bold mb-4">Audio Data Processing</h2>
            <p className="mb-4">When using our MeetingGPT service, our application processes your meeting audio data, including but not limited to:</p>
            <ul className="list-disc pl-8 mb-4">
            ...
            <p className="mb-4">All audio processing is completed locally, ensuring your data is not uploaded or leaked. We implement strict security measures to protect this sensitive information.</p>
            ...
            <p className="mb-4">We may disclose your personal information to any of our employees, officers, contractors, agents, suppliers, or subcontractors insofar as reasonably necessary for the purposes set out in this policy.</p>
            ...
            <p className="mb-4">Information that we collect may be stored, processed, and transferred between any of the countries in which we operate in order to enable us to use the information in accordance with this policy.</p>
            <p className="mb-4">You expressly agree to such transfers of personal information to these overseas entities for our policy purposes.</p>

            <h2 className="text-2xl font-bold mb-4">Retaining Personal Information</h2>
            <p className="mb-4">This section sets out our data retention policies, which are designed to help ensure that we comply with our legal obligations regarding the retention of personal data.</p>
            ...
            <p className="mb-4">Cookies do not typically contain any information that personally identifies you, but personal information that we store about you may be linked to the information stored in and obtained from cookies.</p>
